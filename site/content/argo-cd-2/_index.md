...
annotations:
  dashboard_url: https://grafana.com/d/argo-cd-operational-overview-kask/argocd-operational-overview
  description: ArgoCD in {{ $labels.namespace }} has had more than 50 kubectl request
    retries per minute for the past 10m. This indicates transient Kubernetes API errors
    or throttling.
