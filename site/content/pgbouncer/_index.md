...
expr: |
  pgbouncer_pools_client_waiting_connections{} > 20
for: 5m
labels:
  severity: warning
{{< /code >}}
...
expr: |
  pgbouncer_pools_client_maxwait_seconds{} > 15
for: 5m
labels:
  severity: warning
{{< /code >}}
...
expr: |
  100 * (sum without (database, user) (pgbouncer_pools_server_active_connections{} + pgbouncer_pools_server_idle_connections{} + pgbouncer_pools_server_used_connections{}) / clamp_min(pgbouncer_config_max_user_connections{},1)) > 80
for: 5m
labels:
  severity: warning
{{< /code >}}
...
expr: |
  100 * (sum without (database, user) (pgbouncer_pools_server_active_connections{} + pgbouncer_pools_server_idle_connections{} + pgbouncer_pools_server_used_connections{}) / clamp_min(pgbouncer_config_max_user_connections{},1)) > 90
for: 5m
labels:
  severity: critical
{{< /code >}}
